"""
Django settings for aged_mud_39688 project.
...
ROOT_URLCONF = 'aged_mud_39688.urls'
...
WSGI_APPLICATION = 'aged_mud_39688.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_mud_39688 API",
    "DESCRIPTION": "API documentation for aged_mud_39688 App",
    "VERSION": "v1",
}
